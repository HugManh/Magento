...
class Interceptor extends \Sm\FilterProducts\Block\Product\Renderer\Listing\Configurable implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getPriceFormatJson()
    {
        ...
        if (!$pluginInfo) {
            return parent::getPriceFormatJson();
        } else {
            return $this->___callPlugins('getPriceFormatJson', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getPricesJson()
    {
        ...
        if (!$pluginInfo) {
            return parent::getPricesJson();
        } else {
            return $this->___callPlugins('getPricesJson', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getJsonSwatchConfig()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getJsonSwatchConfig', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getNumberSwatchesPerProduct()
    {
        ...
        if (!$pluginInfo) {
            return parent::getNumberSwatchesPerProduct();
        } else {
            return $this->___callPlugins('getNumberSwatchesPerProduct', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getJsonSwatchSizeConfig()
    {
        ...
        if (!$pluginInfo) {
            return parent::getJsonSwatchSizeConfig();
        } else {
            return $this->___callPlugins('getJsonSwatchSizeConfig', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function decorateArray($array, $prefix = 'decorated_', $forceSetAll = false)
    {
        ...
        if (!$pluginInfo) {
            return parent::decorateArray($array, $prefix, $forceSetAll);
        } else {
            return $this->___callPlugins('decorateArray', func_get_args(), $pluginInfo);
        }
    }
